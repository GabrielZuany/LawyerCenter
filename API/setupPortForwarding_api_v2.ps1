...
$sshCommand = "-f", "-N", "-L", "5001:localhost:5001", "-i", "/home/zuany/Desktop/dev/auth/oracle/sudo/ssh-rsa-30-03-2024.key", "ubuntu@168.138.151.184"

# Start SSH tunnel for port 5001
...
while ($true) {
    ...
    if ($process -eq $null) {
        Write-Output "SSH tunnel for port 5001 closed. Restarting..."
