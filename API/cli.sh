...
sudo docker rm lc_api_container | docker build . -t lc_api_img && docker run --name lc_api_container -v /home/zuany/Desktop/dev/auth/oracle/api:/home/zuany/Desktop/dev/auth/oracle/api -p 5001:5001 -e ASPNETCORE_URLS=http://+:5001 -e ASPNETCORE_ENVIRONMENT=Development lc_api_img